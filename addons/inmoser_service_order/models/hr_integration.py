...
class HrEmployeeServiceIntegration(models.Model):
    ...
    # ------------------------------------------------------------------
    # Campos de servicio y estadísticas
    # ------------------------------------------------------------------
    ...
    # Métodos computados
    # ------------------------------------------------------------------
    @api.depends('timesheet_ids', 'x_inmoser_assigned_orders')
    def _compute_service_statistics(self):
        ...
        for employee in self:
            ...
            # Horas totales
            employee.total_service_hours = sum(employee.timesheet_ids.mapped('hours'))
            ...
            completed_orders = employee.x_inmoser_assigned_orders.filtered(
