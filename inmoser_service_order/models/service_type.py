...
class ServiceType(models.Model):
    ...
    color = fields.Integer(
        string="Color", help="Color para identificación visual en interfaces"
    )
    ...
    sequence = fields.Integer(
        string="Sequence", default=10, help="Orden de visualización en listas"
    )
    ...
    base_price = fields.Float(
        string="Base Price", help="Precio base para este tipo de servicio", default=0.0
    )
    ...
    @api.depends(
        "service_order_ids.scheduled_date",
        "service_order_ids.write_date",
        ...
        for service_type in self:
            ...
            if completed_orders:
                ...
                for order in completed_orders:
                    # Calcular diferencia en horas entre inicio programado y
                    # finalización
                ...
                service_type.avg_completion_time = (
                    total_hours / count if count > 0 else 0
                )
            else:
        ...
        for service_type in self:
            if service_type.estimated_duration <= 0:
                raise ValidationError(
                    _("La duración estimada debe ser mayor que cero.")
                )
    ...
    def get_service_types_for_equipment(self, equipment_type=None):
        ...
        # En el futuro se puede implementar lógica específica por tipo de
        # equipo
